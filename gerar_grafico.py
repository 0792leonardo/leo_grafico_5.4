...
media_3anos = [
    ...
    34.7,33.2,31.8,29.3,28.8,28.6,28.2,27.8,26.9,26.7,28.6,29.3
]

p10 = [
    41.0,41.4,36.0,34.9,33.2,33.0,34.7,32.3,31.7,32.5,34.7,32.1,
    31.2,29.5,28.6,26.2,25.6,24.7,24.3,23.8,23.4,23.0,25.1,26.0
]

p90 = [
    70.0,63.3,57.7,48.3,42.3,42.3,45.1,42.9,41.6,40.3,39.9,37.7,
    39.2,37.9,37.1,34.3,32.1,33.4,32.3,31.0,30.1,29.7,33.0,33.4
]
...
fig.update_layout(
    title="Média móvel de 3 anos — MP₁₀",
